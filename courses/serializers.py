...
class CourseDescriptionSerializer(serializers.ModelSerializer):
    ...
    images = CourseDescriptionImageSerializer(many=True, source="images", read_only=True)
    text = serializers.CharField(source="text")
    order = serializers.IntegerField(source="order")

    class Meta:
        model = CourseDescription
        fields = ("descriptionId", "text", "order", "images", "created_at", "updated_at")



class CourseSerializer(serializers.ModelSerializer):
    descriptions = CourseDescriptionSerializer(many=True, source="descriptions", read_only=True)
    class Meta:
        model = Course
        fields = [
            "course_id",
